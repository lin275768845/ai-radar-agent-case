...
Agent 策略面板：
[docs/zh-CN/STRATEGY_PANEL.md](docs/zh-CN/STRATEGY_PANEL.md)。
...
| [docs/zh-CN/STRATEGY_PANEL.md](docs/zh-CN/STRATEGY_PANEL.md) | 信号选择、证据门禁、发布门禁和人工控制边界的高层策略。 |
| [docs/zh-CN/ARCHITECTURE_OVERVIEW.md](docs/zh-CN/ARCHITECTURE_OVERVIEW.md) | Workflow、trigger、observability 和 public/private boundary 的可视化说明。 |
